...
def test_executed_event_summary_keeps_timing_depth_and_projection():
    events = _executed_event_summary((
        ...
        },
        {
            ...
            "irrigation_event_applied": True,
            "water_budget_projected": True,
            "projection_reasons": ("seasonal_budget",),
        },
    ))
    assert events == [
        {"policy_day": 35, "action_dap": 36, "action_yrdoy": "00154", "applied_mm": 45.0, "projected": False, "projection_reasons": []},
        {"policy_day": 84, "action_dap": 85, "action_yrdoy": "00203", "applied_mm": 9.0, "projected": True, "projection_reasons": ["seasonal_budget"]},
    ]
